...
// Если этот файл когда-нибудь снова доедет до сервера битым, симптом такой:
// адрес отдаёт пустую страницу вместо JSON, а форма заявки на сайте молчит.
// Лечится повторной заливкой с изменением размера файла: деплой сравнивает
// файлы по размеру, и битую копию того же размера он не заменит сам.
